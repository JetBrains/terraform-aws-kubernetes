...
| <a name="input_descheduler_helm_chart_repository"></a> [descheduler\_helm\_chart\_repository](#input\_descheduler\_helm\_chart\_repository) | The URL of the chart to use for descheduler controller | `string` | `"oci://registry.jetbrains.team/p/helm/library"` | no |
...
| <a name="input_descheduler_helm_chart_version"></a> [descheduler\_helm\_chart\_version](#input\_descheduler\_helm\_chart\_version) | The version of the chart to use for descheduler controller | `string` | `"0.31.0"` | no |
