...
| <a name="input_cluster_logging_collector_helm_chart_repository"></a> [cluster\_logging\_collector\_helm\_chart\_repository](#input\_cluster\_logging\_collector\_helm\_chart\_repository) | The URL of the chart to use for the cluster logging service | `string` | `"oci://registry.jetbrains.team/p/helm/library"` | no |
