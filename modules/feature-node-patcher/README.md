...
| <a name="input_cluster_node_rebooter_helm_chart_repository"></a> [cluster\_node\_rebooter\_helm\_chart\_repository](#input\_cluster\_node\_rebooter\_helm\_chart\_repository) | The URL of the chart to use for the cluster monitoring | `string` | `"oci://registry.jetbrains.team/p/helm/library"` | no |
