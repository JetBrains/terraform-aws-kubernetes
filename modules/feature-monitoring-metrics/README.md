...
| <a name="input_cluster_monitoring_helm_chart_repository"></a> [cluster\_monitoring\_helm\_chart\_repository](#input\_cluster\_monitoring\_helm\_chart\_repository) | The URL of the chart to use for the cluster monitoring | `string` | `"oci://registry.jetbrains.team/p/helm/library"` | no |
