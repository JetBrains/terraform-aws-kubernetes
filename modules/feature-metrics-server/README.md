...
| <a name="input_cluster_metrics_server_helm_chart_repository"></a> [cluster\_metrics\_server\_helm\_chart\_repository](#input\_cluster\_metrics\_server\_helm\_chart\_repository) | The URL of the chart to use for the cluster metrics server | `string` | `"oci://registry.jetbrains.team/p/helm/library"` | no |
