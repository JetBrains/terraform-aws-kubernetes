...
module "kube_node_patcher" {
  ...
  cluster_node_rebooter_helm_chart_repository          = try(coalesce(var.cluster_node_patcher.helm_chart_repository, "oci://registry.jetbrains.team/p/helm/library"), "oci://registry.jetbrains.team/p/helm/library")
