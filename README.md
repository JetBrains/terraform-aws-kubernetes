...
| <a name="input_kubernetes_api_version"></a> [kubernetes\_api\_version](#input\_kubernetes\_api\_version) | Specify the version of the Kubernetes API. | `string` | `"1.26"` | no |
